function is_valid_json(file_path) 
{
	try
	 {
			...
			var first_test=text.mapEditorData
			
			var second_test=text.mapEditorData.mapEditorModel.customMapModel.PathData
			
			var third_test=text.mapEditorData.mapEditorModel.customMapModel.MapEditorSettingsData.totalPathPatternSequences
			
			var fourth_test=text.mapEditorData.mapEditorModel.customMapModel.PathData[0].pathEnabledSequence[0]
